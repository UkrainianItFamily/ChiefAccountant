...
{{--                <li class="">Опубликовано</li>--}}
                <li class="">Нормативная база</li>
            </ol>
        </nav>
        <div class="title">ОТЧЕТНОСТЬ</div>
        <div class="otchet__wrap">
            <a href="{{ route('normbasa', ['id'=>11111]) }}"><i class="fas fa-folder"></i><span>Lorem ipsum dolor sit amet, consectetur adipisicing elit</span> </a>
