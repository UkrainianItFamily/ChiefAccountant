...
"use strict";
/*!*************************************************!*\
  !*** ./resources/js/report/reportCategories.js ***!
  \*************************************************/
...
document.querySelector('#mainCategoryList').onclick = function (event) {
  ...
  if (event.target.closest('span')) {
    var categoryId = event.target.closest('span').dataset['id'];
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/report-categories/".concat(categoryId)).then(function (res) {
      console.log(res);
